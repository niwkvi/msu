...
DijkstraOpt::DijkstraOpt(Graph &graph) : path(graph.graphSize), distMin(graph.graphSize),
...
void DijkstraOpt::print() {
    ...
    ofstream f;
    f.open("C:/Users/Gondolin/CLionProjects/27/outDijkstraOpt.txt");
